if ('serviceWorker' in navigator) {
    ...
    function renderMyPage() {
        ...
        // Dummy Coin Calculation: Wins * 50 + Games * 10
        const coins = (pStats.wins * 50) + (pStats.games * 10);
    ...
    const courtDatabase = {
        "MOGUSA": {
            name: "百草テニスガーデン",
            address: "〒191-0033 東京都日野市百草878−1",
            tel: "042-591-1212",
            hours: "9:00～18:00",
            costStr: "¥4,500/h",
            costVal: 4500,
        ...
        "NERIMA": {
            name: "練馬ステップイン",
            address: "〒177-0035 東京都練馬区南田中1丁目15−22",
            tel: "03-3904-7051",
            hours: "9:00～21:30",
            costStr: "¥4,000/h",
            costVal: 4000,
    ...
    function renderScheduleList(targetMonth) {
        ...
        filtered.forEach((item, index) => {
            ...
            // クリック時にグローバルデータのインデックスではなく、フィルタ後のデータを使う必要があるため
            // 直接オブジェクトを渡すか、フィルタ済みのインデックスを使う
